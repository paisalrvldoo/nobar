  ...
  return (
    <main className="min-h-screen bg-[#070707] text-white">
      ...
      <section className="mx-auto flex min-h-[calc(100vh-64px)] max-w-5xl flex-col items-center justify-center px-6 py-20 text-center">
        ...
        <div className="mb-8 flex h-20 w-20 items-center justify-center rounded-3xl border border-white/10 bg-white/[0.04] text-5xl shadow-2xl">
          🍿
        </div>

        <h1 className="max-w-4xl text-5xl font-black leading-[0.95] tracking-[-0.04em] sm:text-7xl md:text-8xl">
        ...
        <p className="mt-8 max-w-lg text-base leading-7 text-white/40">
          Buat room pribadi, ajak orang tersayang kamu,
          dan nonton film bersama secara sinkron.
        </p>
        ...
        <div className="mt-10 flex w-full max-w-md flex-col gap-3">
          ...
          >
            {loading ? "Creating..." : "🎬 Create a Room ❤️"}
          </button>
        ...
        <p className="mt-10 text-xs text-white/20">
          No account required · Just create a room ❤️
        </p>
